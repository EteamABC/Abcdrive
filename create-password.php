          ...
          <div class="shell">
            <div class="range range-xs-center range-xs-center">
              ...
              <div class="cell-sm-8 offset-top-66 offset-lg-top-0">
                ...
                <hr class="divider hr-lg-left-0 bg-mantis">
                <!-- RD Mailform-->
                <form class="rd-mailform text-left" data-form-output="form-output-global" data-form-type="create-password" method="post" action="bat/rd-create-password.php">
                  ...
                  $mysqli = new mysqli('localhost', 'root', '', 'abcdrive_wp662');
                      $sql = 'SELECT * FROM wp9o_users WHERE user_login = '.$card_id.'';
                  ...
                  <div class="range">
                        <input class="form-control input-sm" id="contact-us-name" type="hidden" name="cardnumber" value="<?php echo $card_id; ?>">
                        <input class="form-control input-sm" id="contact-us-name" type="hidden" name="email" value="<?php echo $row['user_email']; ?>">
                    <div class="cell-sm-6">
                      <div class="form-group">
                        <label class="form-label form-label-outside" for="contact-us-email">Password:</label>
