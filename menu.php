                ...
                <div class="rd-navbar-nav-wrap">
                  <div class="rd-navbar-mobile-scroll">
                    ...
                    <ul class="rd-navbar-nav">
                      ...
                      <li><a href="#"><span>About Us</span><span class="rd-navbar-label text-middle label-custom label-danger label-xs-custom label-rounded-custom label">new</span></a>
                        <ul class="rd-navbar-dropdown">
                          <ul class="rd-navbar-dropdown">
                          <li><a href="#"><span class="text-middle">Child Themes</span></a>
                            <ul class="rd-navbar-dropdown">
                      ...
                      <li><a href="ui-kit.html"><span>Contact Us</span></a>
                        <div class="rd-navbar-megamenu">
                          <!-- Responsive-tabs-->
