...
$recipients = 'firstlogin@abcdrive.info';
...
try {
    ...
    $template = file_get_contents('rd-create-password.txt');
    //$template2 = file_get_contents('rd-lost-password.tpl');

    if (isset($_POST['form-type'])) {
        switch ($_POST['form-type']){
            case 'create-password':
                $subject = 'ABC Drive Password';
                break;
            default:
                $subject = 'ABC Drive Password';
                break;
