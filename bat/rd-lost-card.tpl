                  ...
                  <tr>
                    <td align="center" valign="top" style="border-top-left-radius: 4px; border-top-right-radius: 4px; overflow: hidden; padding: 0 20px;background: #302f35;">
                      <table width="100%" align="center" cellpadding="0" cellspacing="0" border="0">
                        ...
                        <tr>
                          <td align="left" valign="top" style="font-family: Arial, sans-serif; font-size: 32px; mso-line-height-rule: exactly; line-height: 32px; font-weight: 400; letter-spacing: 1px;color: #ffffff;">ABC Drive Request for Replacement Card</td>
                        </tr>
                        <tr>
                          <td height="30" style="height: 30px; line-height:30px;"></td>
                        </tr>
                  ...
                  <tr>
                    <td align="center" valign="top" style="padding: 0 20px;">
                      <table width="100%" align="center" cellpadding="0" cellspacing="0" border="0">
                        ...
                        <tr> 
                          <td align="left" valign="top" style="font-family: Arial, sans-serif; font-size: 14px; mso-line-height-rule: exactly; line-height: 22px; font-weight: 400;color: #302f35;">Dear <!-- #{title} --> <!-- #{firstname} --> <!-- #{familyname} -->,</td> 
                        </tr>
                        <tr> 
                          <td align="left" valign="top" style="font-family: Arial, sans-serif; font-size: 14px; mso-line-height-rule: exactly; line-height: 17px; font-weight: 400;color: #302f35;">Your request for a replacement card has been well received. Our team will get back to you within 48 hours excluding Saturday, Sunday and Public Holidays to confirm your details before issuing a new membership card.<br><br></td> 
                        </tr>
                        <tr> 
                          <td align="left" valign="top" style="font-family: Arial, sans-serif; font-size: 14px; mso-line-height-rule: exactly; margin-top: 8px; line-height: 17px; font-weight: 400;color: #302f35;">The card replacement procedure usually takes 10 working days. For reference, please provide your NID at the time of purchase to collect your points.<br><br></td> 
                        </tr>
                        <tr> 
