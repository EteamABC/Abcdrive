        ...
        <div class="shell section-34 section-sm-50">
          <div class="range range-lg-middle">
            ...
            <div class="cell-lg-5 veil reveal-lg-block cell-lg-push-1 text-lg-left">
              <h2><span class="big">Register to Drive</span></h2>
            </div>
            <div class="offset-top-0 offset-sm-top-10 cell-lg-5 offset-lg-top-0 small cell-lg-push-3 text-lg-right">
              <ul class="list-inline list-inline-dashed p">
                <li><a href="index.html">Home</a></li>
                <li><a href="#">My Account</a></li>
                <li>Register to Drive
                </li>
              </ul>
            </div>
          </div>
                  ...
                  <form class="rd-mailform text-left" data-form-output="form-output-global" data-form-type="registration" method="post" action="bat/rd-registration-form.php">
                    <div class="range range-xs-center">
                      ...
                      <div class="cell-sm-12 offset-md-top-30">
                        ...
                        <div class="text-subline offset-top-10"></div>
                        <div class="form-group">
                          <p style="text-align: justify;">I have read the <a href="https://abcdrive.info/assistance/terms-conditions/" target="_blank">Terms and Conditions</a> of "Drive", I hereby consent to ABC BPO Ltd (the Data Controller) using, processing, communicating and sharing my personal data to the ABC Group of Companies for marketing and promotional purposes relating to the "Drive" Customer Loyalty Program. I confirm that the information provided is true, accurate and complete.<br/><span class="wpcf7-form-control-wrap TnC"><input type="checkbox" name="TnC" value="1" class="wpcf7-form-control wpcf7-acceptance" checked="checked" aria-invalid="false"></span> <span style="color:red"><b>Please untick if you do not wish to proceed.</b></span></p>
                        </div>
                      </div>
